...
Open the [hosted AnimoSort app](https://animosort.netlify.app/), read the [How to use guide](https://animosort.netlify.app/how-to-use.html), or open the [About page and interactive EAF-to-week pipeline](https://animosort.netlify.app/about#pipeline). The complete release history is in the [changelog](https://animosort.netlify.app/CHANGELOG.md).
...
AnimoSort reads that EAF locally, normalizes the meeting rows, sorts them by their actual start times, and renders a Monday to Saturday timetable. The [About page](https://animosort.netlify.app/about) shows the supplied Archershub output, the source receipt, and the generated result side by side.
...
Read the [How to use guide](https://animosort.netlify.app/how-to-use.html) for profile, PNG, and calendar workflows. The implementation path is documented in the [interactive Archify pipeline](https://animosort.netlify.app/about#pipeline).

## Screenshots

These screenshots are captured from the current site and focus on the product itself: importing locally, seeing the generated timetable, saving presentation choices, and inspecting the code path. For step-by-step profile and calendar instructions, use the [How to use guide](https://animosort.netlify.app/how-to-use.html#customization-profiles) and its [Google Calendar section](https://animosort.netlify.app/how-to-use.html#google-calendar).
...
See [How to use AnimoSort](https://animosort.netlify.app/how-to-use.html) for the complete walkthrough.
